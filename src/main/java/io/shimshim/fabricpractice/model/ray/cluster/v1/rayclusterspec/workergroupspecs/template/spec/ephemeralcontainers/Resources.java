...
public class Resources implements io.fabric8.kubernetes.api.builder.Editable<ResourcesBuilder>, io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.shimshim.fabricpractice.model.ray.cluster.v1.rayclusterspec.workergroupspecs.template.spec.ephemeralcontainers.resources.Claims> claims;

    public java.util.List<io.shimshim.fabricpractice.model.ray.cluster.v1.rayclusterspec.workergroupspecs.template.spec.ephemeralcontainers.resources.Claims> getClaims() {
        return claims;
    }

    public void setClaims(java.util.List<io.shimshim.fabricpractice.model.ray.cluster.v1.rayclusterspec.workergroupspecs.template.spec.ephemeralcontainers.resources.Claims> claims) {
        this.claims = claims;
    }
