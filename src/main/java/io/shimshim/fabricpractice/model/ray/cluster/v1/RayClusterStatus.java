...
public class RayClusterStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.Map<java.lang.String, String> stateTransitionTimes;

    public java.util.Map<java.lang.String, String> getStateTransitionTimes() {
        return stateTransitionTimes;
    }

    public void setStateTransitionTimes(java.util.Map<java.lang.String, String> stateTransitionTimes) {
