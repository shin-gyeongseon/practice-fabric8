...
public class Resources implements io.fabric8.kubernetes.api.builder.Editable<ResourcesBuilder>, io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.shimshim.fabricpractice.model.ray.cluster.v1alpha1.rayclusterspec.headgroupspec.template.spec.containers.resources.Claims> claims;

    public java.util.List<io.shimshim.fabricpractice.model.ray.cluster.v1alpha1.rayclusterspec.headgroupspec.template.spec.containers.resources.Claims> getClaims() {
        return claims;
    }

    public void setClaims(java.util.List<io.shimshim.fabricpractice.model.ray.cluster.v1alpha1.rayclusterspec.headgroupspec.template.spec.containers.resources.Claims> claims) {
        this.claims = claims;
    }
